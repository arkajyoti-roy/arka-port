    ...
    <div className="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
        <div className="flex md:contents flex-row-reverse">
            <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
                <h3 className="text-lg font-semibold lg:text-xl">School</h3>
                <p className="mt-2 leading-6">Studied in UEMHSS from 2009 to 2021</p>
        ...
        <div className="flex md:contents">
            ...
            <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-6 col-end-10 mr-auto">
                <h3 className="text-lg font-semibold lg:text-xl">Diploma in Computer Science & Technology</h3>
                <p className="mt-2 leading-6">Persuied diploma in Computer Science and Technology from Gomati District Polytechnic </p>
        ...
        <div className="flex md:contents flex-row-reverse">
            <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
                <h3 className="text-lg font-semibold lg:text-xl">Techno Collage of Engineering</h3>
                <p className="mt-2 leading-6">Persuing B.Tech in CSE</p>
